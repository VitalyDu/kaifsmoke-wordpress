...
function amrmeta_validate_mainoptions()	{ 
	...
	if (isset($_POST['use_css_on_pages']) ) {
		$check = explode(',',sanitize_text_field($_POST['use_css_on_pages'])); //20220326
	...
	if (isset($_POST['noaccess_text'])) {  //20220326 - was missing.  But maybe ultimate;y they should use translate
		$return = amrmeta_validate_text('noaccess_text');
		if ( is_wp_error($return) )	echo $return->get_error_message();
	}
