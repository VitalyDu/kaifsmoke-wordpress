...
function amr_users_activate_licenses($licenses) {
		...
		foreach( $_POST['activate'] as $l => $activate ) { // will only do one at a time really
			...
			// fix EDD bug oir lifetime license
			if ($license_data->expires == '1970-01-01 00:00:00') {
				$license_data->success = true;
				$license_data->error = false;
				$license_data->expires = '2099-01-01 00:00:00';
...
*/
	// fix EDD bug for lifetime license //20220322
	if ($license_data->expires == '1970-01-01 00:00:00') {
		$license_data->success = true;
		$license_data->error = false;
		$license_data->expires = '2099-01-01 00:00:00';
	...
	if (!empty($license_data->site_count))
		...
		$license_data->sites_limit = '0';  //20220222 allow for empty site count
