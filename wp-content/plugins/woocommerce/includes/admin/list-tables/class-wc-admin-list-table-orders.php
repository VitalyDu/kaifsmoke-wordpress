...
class WC_Admin_List_Table_Orders extends WC_Admin_List_Table {
	...
	public function define_columns( $columns ) {
        ...
        $show_columns['order_shop']       = __( 'Магазин', 'woocommerce' );
    ...
    /**
     * Render columm: order_shop.
     */
    protected function render_order_shop_column() {
        if (!empty($this->object->get_shipping_address_1())) {
            echo $this->object->get_shipping_address_1();
        }
    }
