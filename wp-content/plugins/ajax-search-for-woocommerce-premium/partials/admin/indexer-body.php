	...
	<div class="progress_bar">
		<div class="pro-bar">
			<small class="progress_bar_title">
				<?php
				$text = __( 'Indexing... This process will continue in the background. You can leave this page.', 'ajax-search-for-woocommerce' );
				...
				echo $text;
				?>
				<span class="progress_number"><?php echo $progressPercent; ?>%</span>
			</small>
