...
class QtranslateXt {
	 ...
	 * @param $success
	 */
	public function insertTranslatedDataIntoReadableIndex( $data, $postID, $postType, $success, $dataUnfiltered ) {
		global $wpdb;
	 ...
	 * @param $data
	 */
	public function insertTranslatedDataIntoVariationIndex( $dataFiltered, $parentProductID, $parentProductSKU, $lang, $data ) {
		global $wpdb;
