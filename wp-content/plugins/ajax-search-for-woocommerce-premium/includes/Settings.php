...
//				),
				...
				2100 => array(
					...
					'label'   => __( 'Show Details panel', 'ajax-search-for-woocommerce' ) . ' ' . Helpers::createQuestionMark( 'details-box',
							__( 'The Details panel is an additional container for extended information. The details are changed dynamically when a user mouse over one of the suggestions.', 'ajax-search-for-woocommerce' ) ),
					'type'    => 'checkbox',
					'size'    => 'small',
			...
			'dgwt_wcas_search'       => apply_filters( 'dgwt/wcas/settings/section=search', array(
				...
				520 => array(
					...
					'label' => __( 'Synonyms', 'ajax-search-for-woocommerce' ) . ' ' . Helpers::createQuestionMark( 'synonyms',
							__( "The synonyms feature allows your users to find more relevant results. If your products have alternative names and users often misspell them, consider adding synonyms.", 'ajax-search-for-woocommerce' ) ),
					'type'  => 'textarea',
					'desc'  => __( 'Synonyms should be separated by a comma. Each new synonyms group is entered on a new line. You can use a phrase instead of a single word. <br /> <br />Sample list:<br /> <br /><span class="dgwt-wcas-synonyms-sample">sofa, couch, davenport, divan, settee<br />big, grand, great, large, outsize</span>',
				...
				625 => array(
					...
					'label'   => __( 'Filtering mode', 'ajax-search-for-woocommerce' ) . ' ' . Helpers::createQuestionMark( 'filter_products_mode',
							__( 'Exclude the product group from the search results or allow search only among the indicated product group', 'ajax-search-for-woocommerce' ), '', 'right' ),
					'class'   => 'js-dgwt-wcas-adv-settings dgwt-wcas-premium-only',
					'type'    => 'select',
					'options' => array(
				...
				650 => array(
					...
					'label'   => __( 'Filters', 'ajax-search-for-woocommerce' ) . ' ' . Helpers::createQuestionMark( 'filter_products_head',
							__( 'Filters that specify the product group that will be affected by the above mode', 'ajax-search-for-woocommerce' ), '', 'right' ),
			...
			'dgwt_wcas_performance'  => apply_filters( 'dgwt/wcas/settings/section=performance', array(
				...
				110 => array(
					...
					'label'   => __( 'Enable Scheduler', 'ajax-search-for-woocommerce' ) . ' ' . Helpers::createQuestionMark( 'indexer-schedule',
							__( "In most cases, you don't need to use the scheduler because the search index updates when you edit products. If you use import tools or custom code to refresh prices or bulk add/edit products, the indexing scheduler will be helpful.", 'ajax-search-for-woocommerce' ) ),
					'type'    => 'checkbox',
					'size'    => 'small',
