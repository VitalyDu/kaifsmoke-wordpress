...
class Helpers {
		...
		switch ( $name ) {
			case 'magnifier-thin':
				...
				<svg version="1.1" class="<?php echo $class; ?>" xmlns="http://www.w3.org/2000/svg"
		             ...
		             <path fill="<?php echo $color; ?>" d="M51.539,49.356L37.247,35.065c3.273-3.74,5.272-8.623,5.272-13.983c0-11.742-9.518-21.26-21.26-21.26 S0,9.339,0,21.082s9.518,21.26,21.26,21.26c5.361,0,10.244-1.999,13.983-5.272l14.292,14.292L51.539,49.356z M2.835,21.082 c0-10.176,8.249-18.425,18.425-18.425s18.425,8.249,18.425,18.425S31.436,39.507,21.26,39.507S2.835,31.258,2.835,21.082z"/>
				</svg>
				<?php
				break;
			case 'magnifier-md':
				...
				<svg class="<?php echo $class; ?>" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
					<path fill="<?php echo $color; ?>" d="M15.5 14h-.79l-.28-.27c1.2-1.4 1.82-3.31 1.48-5.34-.47-2.78-2.79-5-5.59-5.34-4.23-.52-7.79 3.04-7.27 7.27.34 2.8 2.56 5.12 5.34 5.59 2.03.34 3.94-.28 5.34-1.48l.27.28v.79l4.25 4.25c.41.41 1.08.41 1.49 0 .41-.41.41-1.08 0-1.49L15.5 14zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
				</svg>
				<?php
				break;
			case 'arrow-left':
				...
				<svg class="<?php echo $class; ?>" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
					<path fill="<?php echo $color; ?>" d="M14 6.125H3.351l4.891-4.891L7 0 0 7l7 7 1.234-1.234L3.35 7.875H14z" fill-rule="evenodd" />
				</svg>
				<?php
				break;
			case 'close':
				...
				?>
				<svg class="<?php echo $class; ?>" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
					<path fill="<?php echo $color; ?>" d="M18.3 5.71c-.39-.39-1.02-.39-1.41 0L12 10.59 7.11 5.7c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.02 0 1.41L10.59 12 5.7 16.89c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0L12 13.41l4.89 4.89c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L13.41 12l4.89-4.89c.38-.38.38-1.02 0-1.4z"/>
				</svg>
				<?php
				break;
			case 'preloader':
				...
				<svg class="dgwt-wcas-loader-circular <?php echo $class; ?>"  viewBox="25 25 50 50">
					<circle class="dgwt-wcas-loader-circular-path" cx="50" cy="50" r="20" fill="none" stroke="<?php echo $color; ?>" stroke-miterlimit="10"/>
				</svg>
				<?php
				break;
		}
	...
	public static function getFilterProductsRules__premium_only() {
		$rules    = array();
		$rulesRaw = json_decode( DGWT_WCAS()->settings->getOption( 'filter_products_rules' ) );
		if ( empty( $rulesRaw ) ) {
			return $rules;
		}
