...
class ACF {
	...
	function init() {
        ...
        acf_include('includes/fields/class-acf-field-custom_1.php');
        acf_include('includes/fields/class-acf-field-custom_2.php');
        acf_include('includes/fields/class-acf-field-custom_3.php');
