                            ...
                            <li>
                                <svg width="12" height="11" viewBox="0 0 12 11" fill="${
                                  averageRating >= 0.5 ? "1D1D1B" : "none"
                                    ...
                                    <path d="M6 1L7.12257 4.45492H10.7553L7.81636 6.59017L8.93893 10.0451L6 7.90983L3.06107 10.0451L4.18364 6.59017L1.24472 4.45492H4.87743L6 1Z" stroke="#1D1D1B" stroke-width="0.5" stroke-linejoin="round"></path>
                                </svg>
                            </li>
                            <li>
                                <svg width="12" height="11" viewBox="0 0 12 11" fill="${
