$(document).ready(function () {
  ...
  if (USER_ID) {
    ...
    $("body").on("click", ".cartProduct_delete", function () {
      ...
      // $(`.cartProduct_delete[data-productId="${productId}"]`)
      //   .fadeOut()
      //   .remove();
    });
    ...
    if ($(".cartPage_block").length) {
        ...
        map.then((data) => {
          ...
          mapList.map((item) => {
            ...
            $(".cartPage_map .shops-table").append(`
              ...
              }" data-idMultiSklad="${item.id_multisklad}" data-shopAddress="${
              item.address
            }">
                <div class="address">
      ...
      function renderCart(data = null) {
            ...
            $(".cartPage_block__products .products_content").append(`
              ...
              this[key].in_cart_quantity * this[key].price
                ...
                <div class="product_namePrice">
                    <a href="/product/${this[key].slug}" class="product_name">${
              this[key].name
            }</a>
              ...
              this[key].in_cart_quantity * this[key].price
                ...
                <div class="product_stock">
                    ...
                    <span class="product_stock__value">
                        ${productStatus(this[key].in_chosen_shop_stock_status)}
                        ${
        ...
        if (
          ...
          $(".cartPage_block__order").css("display", "flex");
          // $(".customer_agreeWait").css("display", "none");
        } else if ($('.cartProduct[data-stockStatus="1"]').length) {
          // $(".customer_agreeWait").css("display", "flex");
          // $(".cartPage_block__order .deliveryTime").css("display", "flex");
      ...
      // $(".reserveProductsWithExpectation").on("click", function () {
      //   $(".noReserveProductsWithExpectation").removeClass("active");
      //   $(this).toggleClass("active");
      //   rerenderCart();
      //   $(".cartPage_block__order .deliveryTime").css("display", "flex");
      // });
      // $(".noReserveProductsWithExpectation").on("click", function () {
      //   $(".reserveProductsWithExpectation").removeClass("active");
      //   $(this).toggleClass("active");
      //   rerenderCart();
      //   $(".cartPage_block__order .deliveryTime").css("display", "none");
      // });
