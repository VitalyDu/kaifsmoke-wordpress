...
$(document).ready(function () {
  ...
  $(".productCard_block__images").owlCarousel({
    ...
    nav: true,
    navText: [
      `<img src="/wp-content/themes/vapezone/assets/images/productsSliderArrow.png" alt="Влево" class="sliderArrowNotActive"><img src="images/sliderArrowActive.png" alt="Влево" class="sliderArrowActive" style="display: none;">`,
      `<img src="/wp-content/themes/vapezone/assets/images/productsSliderArrow.png" alt="Вправо" class="sliderArrowNotActive"><img src="images/sliderArrowActive.png" alt="Вправо" class="sliderArrowActive" style="display: none;">`,
    ],
    responsive: {
      0: {
        items: 1,
