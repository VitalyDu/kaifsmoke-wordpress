		...
		<div class="container">
			...
			<div class="ordersPage_block">
					...
					<div class="ordersPage_block__order">
						...
						<div class="order_images">
							<div class="order_images__img">
								<img src="images/products/productCard.png" alt="">
							</div>
							<div class="order_images__img">
								<img src="images/products/productCard.png" alt="">
							</div>
						...
						<div class="order_moreDetails">
							<a href="<?php echo esc_url($order->get_view_order_url()); ?>" class="moreDetails_link btn primary s">Подробнее</a>
						</div>
					</div>
				<?php
				}
				...
				<!-- <div class="ordersPage_block__order">
					...
					<div class="order_moreDetails">
						<a href="" class="moreDetails_link">Подробнее</a>
					</div>
				</div>
				<div class="ordersPage_block__order">
					<div class="order_status">
