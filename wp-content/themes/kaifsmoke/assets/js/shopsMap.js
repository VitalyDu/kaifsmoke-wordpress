...
var addPopUp = () => {
  ...
  //       <a href = "/profiles-add/">Регистрация `);
  //   } else if (window.location.hostname == "lovebutik.com") {
  //     $(mainpopup).append(`
  //     <div class = "popup__signin show" >
  //       <a href = "https://lovebutik.com/authorization-ru/?return_url=index.php"> Войти
  //       <a href = "https://lovebutik.com/reg-akk/"> Регистрация `);
  //   }
  // } catch (e) {
  //   console.log(e);
  // }
