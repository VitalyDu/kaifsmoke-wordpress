        ...
        <div class="advantages_block">
            <div class="advantages_block__advantage">
                ...
                <div class="advantage_fullDescription">
                    <p>Доставим товар с основого склада в любой магазин VAPE ZONE в течение 3-7 дней бесплатно</p>
                </div>
            </div>
            <div class="advantages_block__advantage">
...
<?php if (get_field('link_on_video', $prodId)) { ?>
    <section class="videoReview">
        <div class="container">
            <div class="section_title">
                <h1>Видеообзор</h1>
            </div>
            <div class="videoReview_block">
                <div class="videoReview_block__content">
                    <span class="text size-20 bold">
                        Видеообзоры
                    </span>
                    <span class="text size-46 bolder primary videoReview_title">
                        VAPE ZONE
                    </span>
                    <p class="text size-14 regular videoReview_description">
                        Рекомендуем посмотреть
                        наш видеообзор
                    </p>
                </div>
                <div class="videoReview_block__video">
                    <? the_field('link_on_video', $prodId); ?>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="shops-table" id="multisklad">
        ...
        ?>
            <div class="table-item" data-shopaddress="<?= get_post_meta(get_the_id(), 'address', true) ?>">
                ...
                <span data-color="<?= get_post_meta(get_the_id(), 'metro_color', true) ?>"><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="reserveModal" data-productid="" data-address="" data-multisklad="">
    ...
    <div class="reserveModal_buttons">
        ...
        <button class="btn primary m  <? if (!is_user_logged_in()) { ?>reserveModal_button__unAuth<? } else { ?>reserveModal_button__reserve<? } ?>">
