    ...
    <div class="fixedButtons">
        <a href="#" class="upPage">
            <svg class="upPage_icon" width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M23.7071 38.7071C23.3166 39.0976 22.6834 39.0976 22.2929 38.7071C21.9024 38.3166 21.9024 37.6834 22.2929 37.2929L23.7071 38.7071ZM33 28L32.2929 27.2929L33 26.5858L33.7071 27.2929L33 28ZM43.7071 37.2929C44.0976 37.6834 44.0976 38.3166 43.7071 38.7071C43.3166 39.0976 42.6834 39.0976 42.2929 38.7071L43.7071 37.2929ZM22.2929 37.2929L32.2929 27.2929L33.7071 28.7071L23.7071 38.7071L22.2929 37.2929ZM33.7071 27.2929L43.7071 37.2929L42.2929 38.7071L32.2929 28.7071L33.7071 27.2929Z" fill="#000000" />
            </svg>
        </a>
        <a href="" class="chat">
            <svg class="chat_icon" width="66" height="66" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                <!-- <circle cx="33" cy="33" r="32" stroke="#000000" />
        <path d="M19.7011 35.125L20.6785 35.3361C20.6935 35.2668 20.7011 35.196 20.7011 35.125H19.7011ZM24.1113 40.75V39.75C23.9934 39.75 23.8764 39.7708 23.7658 39.8116L24.1113 40.75ZM18 43L17.0225 42.7889L16.6385 44.5669L18.3455 43.9384L18 43ZM20.7011 31.375C20.7011 26.5093 23.7572 23 27.0515 23V21C22.2267 21 18.7011 25.8853 18.7011 31.375H20.7011ZM47 31.375C47 36.2407 43.9439 39.75 40.6496 39.75V41.75C45.4743 41.75 49 36.8647 49 31.375H47ZM40.6496 23C43.9439 23 47 26.5093 47 31.375H49C49 25.8853 45.4743 21 40.6496 21V23ZM27.0515 23H40.6496V21H27.0515V23ZM40.6496 39.75H27.0515V41.75H40.6496V39.75ZM18.7011 31.375V35.125H20.7011V31.375H18.7011ZM24.1113 41.75H27.0515V39.75H24.1113V41.75ZM23.7658 39.8116L17.6545 42.0616L18.3455 43.9384L24.4568 41.6884L23.7658 39.8116ZM18.9775 43.2111L20.6785 35.3361L18.7236 34.9139L17.0225 42.7889L18.9775 43.2111Z" fill="#000000" />
        <g filter="url(#filter0_d)">
            <path d="M31 31.5C31 32.3284 30.3284 33 29.5 33C28.6716 33 28 32.3284 28 31.5C28 30.6716 28.6716 30 29.5 30C30.3284 30 31 30.6716 31 31.5Z" fill="#000000" />
            <path d="M35.5 31.5C35.5 32.3284 34.8284 33 34 33C33.1716 33 32.5 32.3284 32.5 31.5C32.5 30.6716 33.1716 30 34 30C34.8284 30 35.5 30.6716 35.5 31.5Z" fill="#000000" />
            <path d="M40 31.5C40 32.3284 39.3284 33 38.5 33C37.6716 33 37 32.3284 37 31.5C37 30.6716 37.6716 30 38.5 30C39.3284 30 40 30.6716 40 31.5Z" fill="#000000" />
        </g>
        <defs>
        ...
        <div class="container desktopHeader">
            <div class="header_block">
                ...
                <ul itemscope itemtype="https://schema.org/SiteNavigationElement" class="header_block__navigation">
                                    ...
                                    <div class="navigation_profileDropdownNoAuthorized__form auth_form">
                                        ...
                                        <div class="profileDropdown_form__buttons">
                                            <div class="profileDropdown_formButtons__signIn">
                                                <span class="btn s primary modalSignInBtn">Войти</span>
                                            ...
                                            <a href="/signup/" class="btn s secondary profileDropdown_formButtons__signUp">Регистрация</a>
                                        </div>
                                        </вшм>
                                    </div>
                                <? } else { ?>
                    ...
                    <div class="forgotPassword_block">
                        <div class="forgotPassword_block__top">
                            <span>Восстановление пароля</span>
                        </div>
                        <div class="forgotPassword_block__form">
                            <input type="email" name="forgotPasswordEmail" class="" placeholder="Электронная почта">
                            <span class="error_message">Аккаунт с такой почтой не зарегистрирован</span>
                            <button type="submit" class="forgotPasswordButton">
                                Отправить
                            </button>
                        </div>
                    </div>
        ...
        <div class="container mobileHeader onlyMobile">
            <div class="mobileHeader_block">
                <a itemprop="url" href="/" class="mobileHeader_block__logo">
                    <img src="/wp-content/themes/vapezone/assets/images/icons/mobileFullLogo.png" alt="kaifsmoke">
                </a>
                <div class="mobileHeader_block__logoSearchBurger">
                    <a itemprop="url" href="/" class="mobileHeaderFixed_block__logo">
                        <img src="/wp-content/themes/vapezone/assets/images/icons/mobileLogo.png" alt="kaifsmoke">
                    </a>
            ...
            <div class="container">
                <div class="mobileMenuUser_block">
                    ...
                    <div class="mobileMenuUser_logout">
                        <a href="<?php echo wp_logout_url(home_url()); ?>" class="logout_link">Выйти</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="mobileMenuSignIn_block__form auth_form">
                        ...
                        <div class="mobileMenuSignIn_form__buttons">
                            <div class="mobileMenuSignIn_buttons__left">
                                <button class="mobileMenuSignIn_button">Войти</button>
