                ...
                <div class="filter">
                    <div class="filter_status_container">
                        <span class="filter_close">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 8L16 16M16 8L12 12L8 16" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </span>
                        <div class="filter_status">
                            <span class="filter_status__icon">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1H3.4V13H1V1Z" stroke="#000000" stroke-linejoin="round" />
                                    <path d="M5.8 5.8H8.2V13H5.8V5.8Z" stroke="#000000" stroke-linejoin="round" />
                                    <path d="M10.6 3.4H13V13H10.6V3.4Z" stroke="#000000" stroke-linejoin="round" />
                                </svg>
                            </span>
