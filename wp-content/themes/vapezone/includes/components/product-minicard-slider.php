 ...
 <div class="productsBlock_carousel__item product_miniCard" data-productid="<? echo $post->get_id(); ?>" data-productName="<?= $post->get_title() ?>" data-productName="<?= $post->get_title() ?>">
     ...
     <div class="product_rate">
         <ul>
             <li>
                 <svg width="12" height="11" viewBox="0 0 12 11" fill="<? if ($average >= 0.5) { ?>#000000<? } else { ?>none<? } ?>" xmlns="http://www.w3.org/2000/svg">
             ...
             <li>
                 <svg width="12" height="11" viewBox="0 0 12 11" fill="<? if ($average >= 1.5) { ?>#000000<? } else { ?>none<? } ?>" xmlns="http://www.w3.org/2000/svg">
                     <path d="M6 1L7.12257 4.45492H10.7553L7.81636 6.59017L8.93893 10.0451L6 7.90983L3.06107 10.0451L4.18364 6.59017L1.24472 4.45492H4.87743L6 1Z" stroke="#000000" stroke-width="0.5" stroke-linejoin="round" />
                 </svg>
             </li>
             <li>
                 <svg width="12" height="11" viewBox="0 0 12 11" fill="<? if ($average >= 2.5) { ?>#000000<? } else { ?>none<? } ?>" xmlns="http://www.w3.org/2000/svg">
                     <path d="M6 1L7.12257 4.45492H10.7553L7.81636 6.59017L8.93893 10.0451L6 7.90983L3.06107 10.0451L4.18364 6.59017L1.24472 4.45492H4.87743L6 1Z" stroke="#000000" stroke-width="0.5" stroke-linejoin="round" />
                 </svg>
             </li>
             <li>
                 <svg width="12" height="11" viewBox="0 0 12 11" fill="<? if ($average >= 3.5) { ?>#000000<? } else { ?>none<? } ?>" xmlns="http://www.w3.org/2000/svg">
                     <path d="M6 1L7.12257 4.45492H10.7553L7.81636 6.59017L8.93893 10.0451L6 7.90983L3.06107 10.0451L4.18364 6.59017L1.24472 4.45492H4.87743L6 1Z" stroke="#000000" stroke-width="0.5" stroke-linejoin="round" />
                 </svg>
             </li>
             <li>
                 <svg width="12" height="11" viewBox="0 0 12 11" fill="<? if ($average >= 4.5) { ?>#000000<? } else { ?>none<? } ?>" xmlns="http://www.w3.org/2000/svg">
                     <path d="M6 1L7.12257 4.45492H10.7553L7.81636 6.59017L8.93893 10.0451L6 7.90983L3.06107 10.0451L4.18364 6.59017L1.24472 4.45492H4.87743L6 1Z" stroke="#000000" stroke-width="0.5" stroke-linejoin="round" />
                 </svg>
             </li>
         </ul>
         ...
         <?
            ...
            if (is_user_logged_in()) { ?>
             <? if (strpos(get_user_meta(get_current_user_id(), 'cart', true), $post->get_id() . ',') !== false) {
                ?>
                 <a href="/reservation" class="btn tertiary active m goToCart_btn" data-productId="<? echo $post->get_id(); ?>" data-productName="<?= $post->get_title() ?>">Список бронирования</a>
             <?
                } elseif ($post->is_in_stock()) { ?>
                 <button class="btn tertiary m addToCardBtn" data-productId="<? echo $post->get_id(); ?>" data-productName="<?= $post->get_title() ?>">Забронировать</button>
             <? } else { ?>
                 <a href="<?= $post->get_permalink() ?>" class="btn secondary m">Посмотреть</a>
             <?php } ?>
         <? } else { ?>
